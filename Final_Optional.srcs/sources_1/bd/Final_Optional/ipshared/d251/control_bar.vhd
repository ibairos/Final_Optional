...
architecture functional of control_bar is
    -- State definition:
    type state_control is (wait_b, wait_vs_0, wait_vs_3, send_req_0, send_req_3 , rcv_req_0, rcv_req_3, b0_pressed, b3_pressed, wait_erase, write_new, wait_write, vs_one);
	...
	req <= '1' when st = send_req_0 or st = send_req_3 else '0';
    done_bar <= '1' when st = vs_one else '0';
