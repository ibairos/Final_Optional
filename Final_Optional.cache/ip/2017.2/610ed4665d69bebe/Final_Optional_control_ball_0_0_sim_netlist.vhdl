...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_ball is
  signal \/FSM_onehot_st[8]_i_1_n_0\ : STD_LOGIC;
  signal \/FSM_onehot_st[8]_i_2_n_0\ : STD_LOGIC;
  signal \/FSM_onehot_st[8]_i_3_n_0\ : STD_LOGIC;
...
begin
  ...
  done_ball <= \^done_ball\;
  start <= \^start\;
\/FSM_onehot_st[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\/FSM_onehot_st[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\/FSM_onehot_st[8]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F88"
    )
        port map (
