...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_ball is
  ...
  signal plusOp13 : STD_LOGIC_VECTOR ( 9 to 9 );
  ...
  attribute SOFT_HLUTNM of geqOp_carry_i_11 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of geqOp_carry_i_12 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of geqOp_carry_i_9 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \i__carry_i_9__2\ : label is "soft_lutpair1";
begin
  color_t(0) <= \^color_t\(0);
  done_ball <= \^done_ball\;
  game_over <= \^game_over\;
...
geqOp_carry_i_13: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
