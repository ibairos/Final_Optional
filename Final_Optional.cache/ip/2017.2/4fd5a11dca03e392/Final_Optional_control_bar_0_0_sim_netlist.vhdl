...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Final_Optional_control_bar_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_bar is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_bar;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_bar is
  ...
  signal \FSM_sequential_st[3]_i_1_n_0\ : STD_LOGIC;
...
\FSM_sequential_st[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5442"
    )
        port map (
...
\FSM_sequential_st[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CFCFF0FFC0C00AFA"
    )
        port map (
      I0 => \FSM_sequential_st[3]_i_4_n_0\,
      I1 => done,
      I2 => st(0),
      I3 => v_sync,
      I4 => st(3),
...
\FSM_sequential_st[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
req_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
\x_t[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
      I0 => old_sw(1),
      I1 => st(2),
...
\x_t[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
\x_t[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEFFFFB00200008"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "Final_Optional_control_bar_0_0,control_bar,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "control_bar,Vivado 2017.2";
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_bar
     port map (
      btn(1) => btn(3),
      btn(0) => btn(0),
      clk_25 => clk_25,
