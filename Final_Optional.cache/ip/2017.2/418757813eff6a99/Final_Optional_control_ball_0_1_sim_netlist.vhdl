...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_ball is
  ...
  signal \leqOp_inferred__3/i__carry_n_0\ : STD_LOGIC;
  ...
  signal \NLW_leqOp_inferred__3/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_leqOp_inferred__3/i__carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of game_over_var_i_3 : label is "soft_lutpair3";
  attribute METHODOLOGY_DRC_VIOS of geqOp_carry : label is "{SYNTH-8 {cell *THIS*}}";
  attribute SOFT_HLUTNM of geqOp_carry_i_12 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of geqOp_carry_i_13 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of geqOp_carry_i_9 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \i__carry__0_i_3\ : label is "soft_lutpair1";
  ...
  attribute METHODOLOGY_DRC_VIOS of \leqOp_inferred__1/i__carry__0\ : label is "{SYNTH-8 {cell *THIS*}}";
  ...
  attribute METHODOLOGY_DRC_VIOS of \leqOp_inferred__3/i__carry__0\ : label is "{SYNTH-8 {cell *THIS*}}";
  ...
  attribute SOFT_HLUTNM of \ltOp_carry__0_i_4\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \vel_x[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \vel_x[1]_i_1\ : label is "soft_lutpair2";
begin
  color_t(0) <= \^color_t\(0);
  done_ball <= \^done_ball\;
  game_over <= \^game_over\;
...
\leqOp_inferred__3/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \leqOp_inferred__3/i__carry_n_0\,
...
\leqOp_inferred__3/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \leqOp_inferred__3/i__carry_n_0\,
      CO(3 downto 1) => \NLW_leqOp_inferred__3/i__carry__0_CO_UNCONNECTED\(3 downto 1),
      CO(0) => leqOp29_in,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \i__carry__0_i_1__6_n_0\,
      O(3 downto 0) => \NLW_leqOp_inferred__3/i__carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
