...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control_ball is
  ...
  signal leqOp11_in : STD_LOGIC;
  signal leqOp14_in : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \geqOp_carry__0_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of geqOp_carry_i_10 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of geqOp_carry_i_11 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \i__carry_i_10__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \i__carry_i_10__1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \i__carry_i_9__5\ : label is "soft_lutpair2";
begin
  color_t(0) <= \^color_t\(0);
  done_ball <= \^done_ball\;
  game_over <= \^game_over\;
...
\geqOp_carry__0_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\new_sw_x[9]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
vel_y_i_2: unisim.vcomponents.LUT6
    generic map(
...
vel_y_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
vel_y_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
