...
HD_PWD='C:/Users/ibai.ros/Final_Optional/Final_Optional.runs/Final_Optional_mem_control_unit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_Optional_mem_control_unit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Final_Optional_mem_control_unit_0_0.tcl
